<div class="right-sidebar">
	<div class="sidebar-title">
		<h3 class="weight-600 font-16 text-blue">
			Diseño de la pagina
			<span class="btn-block font-weight-400 font-12">Configuración de interfaz de usuario</span>
		</h3>
	...
	<div class="right-sidebar-body customscroll">
		<div class="right-sidebar-body-content">
			<h4 class="weight-600 font-18 pb-10">Color de barra superior</h4>
			...
			<h4 class="weight-600 font-18 pb-10">Color de barra de menu</h4>
			<div class="sidebar-btn-group pb-30 mb-10">
			...
			<!--<div class="reset-options pt-30 text-center">
				<button class="btn btn-danger" id="reset-settings">Reiniciar configuración</button>
			</div>-->
		</div>
	</div>
</div>